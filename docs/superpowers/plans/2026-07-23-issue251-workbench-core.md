...
**분량**(계획 정의대로 `git diff --numstat master -- src scripts deploy e2e` 순증): **2,031**
(프로덕션 **744** · 배수 **2.73**). **상한 1,900 대비 +7% · 프로덕션 목표 ≤400 대비 +86%** —
**은폐하지 않는다**(PR3b 정정 181 과 같은 규율). ⚠ 최종 수치는 머지 직후 `origin/master` 기준으로
재측정해 PR 본문에 적는다.
