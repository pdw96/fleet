...
| **PR3a** | `GitRepo` 완성(열거 포함 10메서드) · 능력 프로브 · R-5 삭제 없는 재시도 | T11·T12 | **실측 1,143**(프로덕션 272) | 없음(상한 내 · 60%) |
...
- **뮤테이션 12종 전부 RED**. 값 큰 것: 「merge-tree 판별을 종료코드로」·「refExists 를 rev-parse 로」·
