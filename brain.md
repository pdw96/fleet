...
> 99 files · 238 import wires · 47 IPC channels · 생성 2026-07-28T07:56 UTC
...
- **workbench/authority**
  - →의존: shared/types, workbench/durable-fs, workbench/locks · ←피의존: workbench/locks · 1254줄
...
- **workbench/durable-fs**
  - →의존: — · ←피의존: workbench/__testing__/durable-fs-fake, workbench/authority · 208줄
...
- **workbench/__testing__/durable-fs-fake**
  - →의존: workbench/durable-fs · ←피의존: — · 248줄
