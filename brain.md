...
> 58 files · 143 import wires · 41 IPC channels · 생성 2026-06-22T05:21 UTC
...
## 한눈에
- **허브**(많이 연결): shared/types(38) · engine(25) · providers/types(11) · main/index(11) · orchestrator/orchestrator(10) · tools/types(10)
...
- **providers/openai** — OpenAI(GPT) 및 같은 방식을 쓰는 호환 AI 와 대화하는 전용 창구 _GPT 에게 질문을 보내고 답을 받아오며, o1·GPT-5 같은 추론 모델이 거부하는 설정(온도·토큰 항목 등)을 모델에 맞게 알아서 바꿔 보낸다. 같은 방식을 쓰는 다른 회사 AI(openai-compatible)도 이 창구로 함께 처리한다._
  - →의존: providers/sse, providers/types, shared/types · ←피의존: providers/registry · 490줄
