...
> 102 files · 246 import wires · 47 IPC channels · 생성 2026-08-12T08:37 UTC
...
- **workbench/authority**
  - →의존: shared/types, workbench/durable-fs, workbench/locks · ←피의존: workbench/journal, workbench/locks, workbench/recovery · 1778줄
- **workbench/journal**
  - →의존: workbench/authority, workbench/durable-fs, workbench/locks, workbench/ulid · ←피의존: workbench/recovery · 1014줄
...
- **workbench/recovery**
  - →의존: workbench/authority, workbench/journal, workbench/result-ref · ←피의존: — · 513줄
- **workbench/ulid**
...
- **workbench/result-ref**
  - →의존: workbench/ulid · ←피의존: workbench/recovery · 119줄
